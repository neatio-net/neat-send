<template>
    <div class="Connect">
        ...
        <!--        </div>-->
        <div
                style="border-top: 1px solid #ebedf0;background-color: #192841;height: 44px;padding: 10px 0;width: 100%;position: fixed;bottom: 0">
            <el-row>
                <el-col :span="12">
